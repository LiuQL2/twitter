...
class CommunityTopicWordCloudApril(communityTopicWordCloud):
    ...
    def plot_word_cloud(self, image_save_to,number_of_community = 0,community_id_list = list(),full_width_community = False):
        ...
        for community_id in community_id_list:
            ...
            for key, language_community_topic in self.community_topics[community_id].items():
...
if __name__ == '__main__':
    directory_list = ['01_07','08_14','15_21','22_28','29_30']
    ...
    image_save_to = 'D:/LiuQL/eHealth/twitter/wordCloud/Arpil/word_cloud_image/community_topic_words_image/'
